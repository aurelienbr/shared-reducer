...
function findMainFile(context, dists) {
    ...
    var pathPrefix = "" + compDistRoot + (compDistRoot.endsWith(path_1.default.sep) ? '' : path_1.default.sep);
...
function createTSConfig(context) {
    return __awaiter(this, void 0, void 0, function () {
        var configUserOverrides, isDev, content, pathToConfig;
        return __generator(this, function (_a) {
            configUserOverrides = context.cc.dynamicConfig.tsconfig;
            isDev = context.cc.dynamicConfig.development;
            content = tsconfig_2.getTSConfig(isDev, configUserOverrides);
...
function collectNonDistFiles(context) {
    return __awaiter(this, void 0, void 0, function () {
        var dynamicConfig, copyPolicy, capsuleDir, compDistRoot, ignoreFunction, fileList, readFiles, list;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dynamicConfig = context.cc.dynamicConfig;
                    copyPolicy = dynamicConfig.copyPolicy;
                    if (lodash_1.has(dynamicConfig, 'copyPolicy.disable') && copyPolicy.disable) {
                    ...
                    ignoreFunction = function (file, _stats) {
                        ...
                        var defaultIgnore = ["node_modules" + path_1.default.sep, tsconfig_1.FIXED_OUT_DIR, '.dependencies', '.ts'];
